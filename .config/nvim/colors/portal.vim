...
let s:colorBlackIntense   = "#000000" " 0
let s:colorRed            = "#e7301b" " 1
let s:colorRedIntense     = "#ed1515" " 1
let s:colorGreen          = "#1cdc9a" " 2
let s:colorGreenIntense   = "#11d116" " 2
let s:colorYellow         = "#fdbc4b" " 3
let s:colorYellowIntense  = "#f67400" " 3
let s:colorBlue           = "#3daee9" " 4
let s:colorBlueIntense    = "#1d99f3" " 4
let s:colorMagenta        = "#a968c3" " 5
let s:colorMagentaIntense = "#9c4abf" " 5
let s:colorCyan           = "#16a085" " 6
let s:colorCyanIntense    = "#1abc9c" " 6
let s:colorWhite          = "#e0e2ea" " 7 NvimLightGrey2
let s:colorWhiteIntense   = "#ffffff" " 7
...
let g:terminal_color_8 = s:colorBlackIntense
let g:terminal_color_9 = s:colorRedIntense
let g:terminal_color_10 = s:colorGreenIntense
let g:terminal_color_11 = s:colorYellowIntense
let g:terminal_color_12 = s:colorBlueIntense
let g:terminal_color_13 = s:colorMagentaIntense
let g:terminal_color_14 = s:colorCyanIntense
let g:terminal_color_15 = s:colorWhiteIntense
